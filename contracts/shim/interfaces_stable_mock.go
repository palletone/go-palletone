...
func (m *MockChaincodeStubInterface) PutContractState(contractAddr common.Address, key string, value []byte) error {
	ret := m.ctrl.Call(m, "PutContractState", contractAddr, key, value)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockChaincodeStubInterfaceMockRecorder) PutContractState(contractAddr, key, value interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutContractState", reflect.TypeOf((*MockChaincodeStubInterface)(nil).PutContractState), contractAddr, key, value)
}
