...
// Header represents a block header in the PalletOne blockchain.
type Header struct {
...
// Block represents an entire block in the PalletOne blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the PalletOne
...
// EncodeRLP serializes b into the PalletOne RLP block format.
