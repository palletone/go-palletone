...
func createCIS(ccname string, args [][]byte) (*pb.PtnChaincodeInvocationSpec) {
	spec := &pb.PtnChaincodeInvocationSpec{ChaincodeSpec: &pb.PtnChaincodeSpec{Type: pb.PtnChaincodeSpec_Type(pb.PtnChaincodeSpec_Type_value["GOLANG"]), ChaincodeId: &pb.PtnChaincodeID{Name: ccname}, Input: &pb.PtnChaincodeInput{Args: args}}}
	return spec
}
