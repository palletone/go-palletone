...
//		address0                  = common.PubKeyHashHexToAddress("70c87d191324e6712a591f304b4eedef6ad9bb9d")
//		address1                  = common.PubKeyHashHexToAddress("9b2055d370f73ec7d8a03e965129118dc8f5bf83")
...
//	vector = fmt.Sprintf(`{"address": "0x%x"}`, address0)
...
//	vector = fmt.Sprintf(`{"address": ["0x%x", "0x%x"]}`, address0, address1)
