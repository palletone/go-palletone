...
func (m *Mockproducer) AddToTBLSRecoverBuf(sigShare *mediatorplugin.SigShareEvent, header *modules.Header) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddToTBLSRecoverBuf", sigShare, header)
}
...
func (mr *MockproducerMockRecorder) AddToTBLSRecoverBuf(sigShare, header interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddToTBLSRecoverBuf", reflect.TypeOf((*Mockproducer)(nil).AddToTBLSRecoverBuf), sigShare, header)
}
