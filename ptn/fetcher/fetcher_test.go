...
var (
	...
	unknownBlock = types.NewBlock(&types.Header{GasLimit: configure.GenesisGasLimit}, nil, nil, nil)
)
...
func makeChain(n int, seed byte, parent *types.Block) ([]common.Hash, map[common.Hash]*types.Block) {
	blocks, _ := core.GenerateChain(configure.TestChainConfig, parent, ethash.NewFaker(), testdb, n, func(i int, block *core.BlockGen) {
