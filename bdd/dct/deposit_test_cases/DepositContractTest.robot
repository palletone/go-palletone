...
Business_01
    ...
    ${result}    applyQuitMediator    ${mediatorAddr_01}    MediatorApplyQuitMediator    #该节点申请退出mediator候选列表
    log    ${result}
...
Business_02
    ...
    ${result}    mediatorPayToDepositContract    ${mediatorAddr_02}    ${medDepositAmount}    #节点交付2100 0000 0000
    log    ${result}
...
Business_03
    ...
    ${resul}    juryPayToDepositContract    ${juryAddr_01}    100000000000000    #jury交付400 0000 0000
    log    ${resul}
...
Business_05
    ...
    ${resul}    developerPayToDepositContract    ${developerAddr_01}    1000000000000    #dev交付400 0000 0000
    log    ${resul}
