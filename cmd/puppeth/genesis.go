...
// newCppEthereumGenesisSpec converts a go-palletone genesis block into a Parity specific
// chain specification format.
func newCppEthereumGenesisSpec(network string, genesis *coredata.Genesis) (*cppEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-palletone and cpp-ethereum
	...
	spec.Params.MaximumExtraDataSize = (hexutil.Uint64)(configure.MaximumExtraDataSize)
	spec.Params.MinGasLimit = (hexutil.Uint64)(configure.MinGasLimit)
	spec.Params.MaxGasLimit = (hexutil.Uint64)(math.MaxUint64)
	spec.Params.MinimumDifficulty = (*hexutil.Big)(configure.MinimumDifficulty)
	spec.Params.DifficultyBoundDivisor = (*hexutil.Big)(configure.DifficultyBoundDivisor)
	spec.Params.GasLimitBoundDivisor = (hexutil.Uint64)(configure.GasLimitBoundDivisor)
	spec.Params.DurationLimit = (*hexutil.Big)(configure.DurationLimit)
...
// newParityChainSpec converts a go-palletone genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *coredata.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-palletone and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	// Reconstruct the chain spec in Parity's format
	...
	spec.Engine.Ethash.Params.MinimumDifficulty = (*hexutil.Big)(configure.MinimumDifficulty)
	spec.Engine.Ethash.Params.DifficultyBoundDivisor = (*hexutil.Big)(configure.DifficultyBoundDivisor)
	spec.Engine.Ethash.Params.DurationLimit = (*hexutil.Big)(configure.DurationLimit)
	...
	spec.Params.GasLimitBoundDivisor = (hexutil.Uint64)(configure.GasLimitBoundDivisor)
	spec.Params.NetworkID = (hexutil.Uint64)(genesis.Config.ChainId.Uint64())
	spec.Params.MaxCodeSize = configure.MaxCodeSize
...
type pyEthereumGenesisSpec struct {
	...
	Alloc      coredata.GenesisAlloc `json:"alloc"`
	ParentHash common.Hash           `json:"parentHash"`
}

// newPyEthereumGenesisSpec converts a go-palletone genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *coredata.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-palletone and pyethereum
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
