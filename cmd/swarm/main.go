...
import (
	...
	bzzapi "github.com/palletone/go-palletone/swarm/api"
	swarmmetrics "github.com/palletone/go-palletone/swarm/metrics"
...
func init() {
	...
	defaultNodeConfig.Version = configure.VersionWithCommit(gitCommit)
