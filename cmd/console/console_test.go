...
func newTester(t *testing.T, confOverride func(*pan.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return pan.New(ctx, ethConf) }); err != nil {
