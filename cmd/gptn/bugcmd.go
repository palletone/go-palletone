...
var bugCommand = cli.Command{
	...
	Name:      "bug",
	Usage:     "opens a window to report a bug on the gptn repo",
	ArgsUsage: " ",
...
// reportBug reports a bug by opening a new URL to the go-palletone GH issue
...
func reportBug(ctx *cli.Context) error {
	...
	fmt.Fprintln(&buff)
	fmt.Fprintln(&buff, "Version:", configure.Version)
