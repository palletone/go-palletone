...
func (mr *MockIDagMockRecorder) GetTxByFileHash(filehash interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTxByFileHash", reflect.TypeOf((*MockIDag)(nil).GetTxByFileHash), filehash)
}
