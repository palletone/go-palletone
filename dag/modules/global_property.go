...
//}
//
//func NewGlobalProp(statedb storage.StateDb) *GlobalProperty {
...
//}
//
//func getGP(gpt *GlobalPropertyStore,StateDb storage.StateDb) *GlobalProperty {
...
//}
//
//func StoreGlobalProp (db storage.StateDb, gp *GlobalProperty) error {
//	gpt := getGPT(gp)
//	return db.SaveGlobalProperty(gpt)
//}
//
//func StoreDynGlobalProp(db storage.StateDb, dgp *DynamicGlobalProperty) error {
//	return db.SaveDynamicGlobalProperty(*dgp)
//}
//
//func RetrieveGlobalProp(db storage.StateDb) (*GlobalProperty, error) {
//	gpt, err := db.GetGlobalProperty()
//	gp := getGP(&gpt,db)
//	return gp, err
//}
//
//func RetrieveDynGlobalProp(db storage.StateDb) (*DynamicGlobalProperty, error) {
