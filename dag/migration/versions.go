...
func NewMigrations(db ptndb.Database) map[string]IMigration {
	...
	m_105_hotfix1 := NewNothingMigration("1.0.5-release", "1.0.5-hotfix1")
	migrations[m_105_hotfix1.FromVersion()] = m_105_hotfix1
	...
	migrations["1.0.8-alpha"] = NewNothingMigration("1.0.7-hotfix1", "1.0.8-alpha")
