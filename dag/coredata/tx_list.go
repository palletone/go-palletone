...
func (l *txList) Filter(costLimit *big.Int, gasLimit uint64) (modules.Transactions, modules.Transactions) {
	...
	removed := l.txs.Filter(func(tx *modules.Transaction) bool { return tx.Cost().Cmp(costLimit) > 0 || tx.Gas() > gasLimit })
