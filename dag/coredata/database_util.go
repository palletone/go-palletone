...
// found.
func GetHeader(db DatabaseReader, hash common.Hash, number uint64) *modules.Header {
...
// its added positional metadata.
func GetReceipt(db DatabaseReader, hash common.Hash) (*modules.Receipt, common.Hash, uint64, uint64) {
	return &modules.Receipt{}, common.Hash{}, uint64(0), uint64(0)
}
...
func WriteHeader(db ptndb.Putter, header *modules.Header) error {
	return nil
}
