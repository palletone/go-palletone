...
func WriteCanonicalHash(db ptndb.Putter, hash common.Hash, number uint64) error {
	return nil
}

// WriteHeadHeaderHash stores the head header's hash.
func WriteHeadHeaderHash(db ptndb.Putter, hash common.Hash) error {
	return nil
}

// WriteHeadBlockHash stores the head block's hash.
func WriteHeadBlockHash(db ptndb.Putter, hash common.Hash) error {
	return nil
}

// WriteHeadFastBlockHash stores the fast head block's hash.
func WriteHeadFastBlockHash(db ptndb.Putter, hash common.Hash) error {
	return nil
}
...
func WriteHeader(db ptndb.Putter, header *types.Header) error {
	return nil
}

// WriteBody serializes the body of a block into the database.
func WriteBody(db ptndb.Putter, hash common.Hash, number uint64, body *types.Body) error {
	return nil
}

// WriteTd serializes the total difficulty of a block into the database.
func WriteTd(db ptndb.Putter, hash common.Hash, number uint64, td *big.Int) error {
	return nil
}

// WriteBlock serializes a block into the database, header and body separately.
func WriteBlock(db ptndb.Putter, block *types.Block) error {
	return nil
}
...
func WriteBlockReceipts(db ptndb.Putter, hash common.Hash, number uint64, receipts types.Receipts) error {
	return nil
}

// WriteTxLookupEntries stores a positional metadata for every transaction from
// a block, enabling hash based transaction and receipt lookups.
func WriteTxLookupEntries(db ptndb.Putter, block *types.Block) error {
	return nil
}

// WriteBloomBits writes the compressed bloom bits vector belonging to the given
// section and bit index.
func WriteBloomBits(db ptndb.Putter, bit uint, section uint64, head common.Hash, bits []byte) {
...
func PreimageTable(db ptndb.Database) ptndb.Database {
	return nil
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db ptndb.Database, number uint64, preimages map[common.Hash][]byte) error {
	return nil
}
...
func WriteBodyRLP(db ptndb.Putter, hash common.Hash, number uint64, rlp rlp.RawValue) error {
	return nil
}
