...
# subprocess.call("sed -i 's/\"min_maint_skip_slots\": 0,/\"min_maint_skip_slots\": 0,/g' ptn-genesis.json",shell=True)
...
subprocess.call("sed -i 's/EnableGasFee: true,/EnableGasFee: false,/g' ptn-config.toml",shell=True)
