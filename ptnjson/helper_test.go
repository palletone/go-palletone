...
func TestAssetAmt2JsonAmt(t *testing.T) {
	asset, _ := modules.NewAsset("TEST", modules.AssetType_FungibleToken, 4, []byte{1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 11, 12, 13}, modules.UniqueIdType_Null, modules.AssetId{})
...
func TestJsonAmt2AssetAmt(t *testing.T) {
	asset, _ := modules.NewAsset("TEST", modules.AssetType_FungibleToken, 5, []byte{1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 11, 12, 13}, modules.UniqueIdType_Null, modules.AssetId{})
