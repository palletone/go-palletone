...
# 1. install gpan for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gpan
# 5. create gpan, attach and uninstall start menu entries
...
!define GROUPNAME "PalletOne"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the PalletOne protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gpan is installed global
