...
var (
	...
	authorsFileHeader = "# This is the official list of go-palletone authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-palletone Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-palletone library"
	}
	return "the go-palletone library"
}
