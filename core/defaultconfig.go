...
const (
	...
	DefaultUccMemory = 104857600

	DefaultUccCpuShares  = 1024
	DefaultUccCpuQuota   = 100000
	DefaultUccDisk       = 27262976
	DefaultUccPrivileged = false
	//DefaultUccNetworkMode    = "bridge" //TODO xiaozhi 测试容器运行网络模式
