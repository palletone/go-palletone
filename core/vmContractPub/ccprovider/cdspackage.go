...
//
//	//metadata hash
//	tmp := cds.ChaincodeSpec.ChaincodeId.Name + cds.ChaincodeSpec.ChaincodeId.Version
//	cdsdata.MetaDataHash = util.ComputeSHA256([]byte(tmp))
//
...
//	//compute the id
//	var tmp2 string
//	fmt.Sprintf(tmp2, "%s%s", cdsdata.CodeHash, cdsdata.MetaDataHash)
//	id := util.ComputeSHA256([]byte(tmp2))
//
