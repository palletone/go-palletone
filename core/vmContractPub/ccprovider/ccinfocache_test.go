...
func TestCCInfoCache(t *testing.T) {
	ccname := "foo"
	ccver := "1.0"
	ccpath := "github.com/palletone/go-palletone/contracts/example/go/chaincode_example02"
...
func TestPutChaincode(t *testing.T) {
	ccname := ""
	ccver := "1.0"
	ccpath := "github.com/palletone/go-palletone/contracts/examples/go/chaincode_example02"
