...
func (l *AuditLogger) List(ctx context.Context) (Accounts, error) {
	log.Info("List", "type", "request", "metadata", MetadataFromContext(ctx).String())
	res, e := l.api.List(ctx)

	log.Info("List", "type", "response", "data", res.String())
