...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/palletone/go-palletone/tokenengine/btcutil)
...
```bash
$ go get -u github.com/palletone/go-palletone/tokenengine/btcutil
```
