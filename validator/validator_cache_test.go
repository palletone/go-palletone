...
func TestValidatorCache_HasTxValidateResult(t *testing.T) {
	add := make([]*modules.Addition, 0)
	addr, _ := common.StringToAddress("P1HHQt1cMWrj3WBVmsTXYBsawwg2wrD6of6")
	add = append(add, &modules.Addition{Addr:addr, Amount: 123, Asset: modules.NewPTNAsset()})
