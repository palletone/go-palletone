...
func (bc *LightChain) ResetWithGenesisBlock(genesis *modules.Unit) {
...
//func (self *LightChain) GetBody(ctx context.Context, hash common.Hash) (*modules.Body, error) {
...
// caching it if found.
func (self *LightChain) GetBlockByHash(ctx context.Context, hash common.Hash) (*modules.Unit, error) {
...
func (self *LightChain) GetBlockByNumber(ctx context.Context, number uint64) (*modules.Unit, error) {
	return nil, nil
...
func (self *LightChain) InsertHeaderChain(chain []*modules.Header, checkFreq int) (int, error) {
	return 0, nil
...
func (self *LightChain) CurrentHeader() *modules.Header {
	return nil
...
// caching it if found.
func (self *LightChain) GetHeader(hash common.Hash, number uint64) *modules.Header {
	return nil
...
// found.
func (self *LightChain) GetHeaderByHash(hash common.Hash) *modules.Header {
	return nil
...
func (self *LightChain) GetHeaderByNumber(number uint64) *modules.Header {
	return nil
...
func (self *LightChain) GetHeaderByNumberOdr(ctx context.Context, number uint64) (*modules.Header, error) {
...
func (self *LightChain) SubscribeChainEvent(ch chan<- modules.ChainEvent) event.Subscription {
	return self.scope.Track(self.chainFeed.Subscribe(ch))
}

// SubscribeChainHeadEvent registers a subscription of ChainHeadEvent.
func (self *LightChain) SubscribeChainHeadEvent(ch chan<- modules.ChainHeadEvent) event.Subscription {
	return self.scope.Track(self.chainHeadFeed.Subscribe(ch))
}

// SubscribeChainSideEvent registers a subscription of ChainSideEvent.
func (self *LightChain) SubscribeChainSideEvent(ch chan<- modules.ChainSideEvent) event.Subscription {
