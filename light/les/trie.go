...
//func NewState(ctx context.Context, head *modules.Header, odr OdrBackend) *state.StateDB {
...
func (t *odrTrie) Prove(key []byte, fromLevel uint, proofDb ptndb.Putter) error {
