...
func Test_WriteFolderToTarPackage1(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/palletone/go-palletone/contracts/example/java/SimpleSample")
...
func Test_WriteFolderToTarPackage2(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/palletone/go-palletone/contracts/examples/java")
	excludeFileTypes := map[string]bool{
		".xml": true,
	}
...
func Test_WriteFolderToTarPackage5(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/palletone/go-palletone/contracts/examples/go/BadMetadataIgnoreHiddenFile")
...
func Test_WriteFolderToTarPackageFailure1(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/palletone/go-palletone/vm/util",
